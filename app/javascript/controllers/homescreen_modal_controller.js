...
// Connects to data-controller="homescreen-modal"
export default class extends Controller {
  ...
  // Set cookie and close when user dismisses
  dismiss() {
    // Set cookie to remember user has seen this modal
    document.cookie = "homescreen_notification_shown=true; max-age=" + (365 * 24 * 60 * 60) + "; path=/; SameSite=Lax"
    this.close()
  }

  // Set cookie and close when user clicks "Got it" or similar action
  gotIt() {
    this.dismiss()
  }
}